...
print("Mesin sedang melakukan training data wajah. Tunggu daam beberapa detik.")
faces,IDs = getImageLabel(wajahDir)
faceRecognizer.train(faces,np.array(IDs))

faceRecognizer.write(latihDir+'/training.xml')
print("Sebanyak {0} data wajah teah ditrainingkan ke mesin.",format(len(np.unique(IDs))))
